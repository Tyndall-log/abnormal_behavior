...
# 비디오 파일이 있는 폴더 경로
# video_folder_path = os.path.abspath("G:/abnormal_behavior_wsl/Dataset/assult/outsidedoor_06/23-6")
# video_folder_path = os.path.abspath("E:/내 드라이브/machine_learning/dataset/assult/outsidedoor_06/23-6")
video_folder_paths = [
    "E:/내 드라이브/machine_learning/dataset/assult/outsidedoor_06/23-6",
    "E:/내 드라이브/machine_learning/dataset/assult/outsidedoor_06/25-1",
]
