...
# 모델 저장
joblib.dump(catboost_model, 'catboost(velocities)/catboost_model.joblib')
joblib.dump(label_encoder, 'catboost(velocities)/label_encoder.joblib')

# 모델 불러오기 (예시)
# loaded_catboost_model = joblib.load('catboost_model.joblib')
